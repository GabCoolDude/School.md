...
| Action principale ( qui fait avance l'histoire ) | Action secondaire ( qui ne fait pas directement<br>avancer l'histoire) |
...
| Succession d’action (d’abord, ensuite,<br>puis, etc.).<br>Il faut que l’action soit finie pour <br>entamer la suivante. |  |
|  |  |